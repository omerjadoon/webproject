                  ...
                  <div class="bg-primary b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0">Total Amount</span>
                        <h4 class="mb-0">{{number_format(Auth::user()->businessadshasmanyleads->sum('total_amount'))}} Cent</h4><i class="icon-bg" data-feather="database"></i>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="bg-secondary b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0">Amount Payed</span>
                        <h4 class="mb-0">{{number_format(Auth::user()->businessadshasmanyleads->where('bfa_tot_status',3)->sum('total_amount'))}} Cent</h4><i class="icon-bg" data-feather="pocket"></i>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="bg-primary b-r-4 card-body">
                    <div class="media static-top-widget">
                      ...
                      <div class="media-body"><span class="m-0">Amnount Remaining</span>
                        <h4 class="mb-0">{{number_format(Auth::user()->businessadshasmanyleads->sum('total_amount')-Auth::user()->businessadshasmanyleads->where('bfa_tot_status',3)->sum('total_amount'))}} Cent</h4><i class="icon-bg" data-feather="layers"></i>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    <div class="media align-items-center">
                      <div class="media-body right-chart-content">
                        <h4>{{Auth::user()->businesshasmanyads->count()}}
              ...
              <div class="col-xl-3 xl-50 chart_data_right second d-none"> 
                <div class="card">
                  <div class="card-body">
                    <div class="media align-items-center">
                      <div class="media-body right-chart-content"> 
                        <h4>{{Auth::user()->businessadshasmanyleads->count()}}
