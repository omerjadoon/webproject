      ...
      <div class="page-header">
        <div class="header-wrapper row m-0">
          ...
          <div class="header-logo-wrapper">
            <div class="logo-wrapper"><a href="{{route('main')}}"><img class="img-fluid" src="{{asset('user/assets/images/logo/logo.png')}}" alt=""></a></div>
...
<!--               <li class="onhover-dropdown">
             ...
             <!--  <li class="cart-nav onhover-dropdown">
              ...
              <li class="profile-nav onhover-dropdown p-0 mr-0">
                <div class="media profile-media"><img class="b-r-10" src="{{asset(Auth::user()->file_path)}}" width="37px" height="37px" alt="">
                  <div class="media-body"><span>{{Auth::user()->f_name}} {{Auth::user()->l_name}}</span>
                    <p class="mb-0 font-roboto">{{Auth::user()->role=='buisness' ? 'Business' : 'Media Partner'}} <i class="middle fa fa-angle-down"></i></p>
                  </div>
                </div>
                <ul class="profile-dropdown onhover-show-div">
                  <li><a href="{{Auth::user()->role=='buisness' ? route('account') : route('media_account')}}"><i data-feather="user"></i><span>Account </span></a></li>
                  <li><a href="{{route('change_password')}}"><i data-feather="settings"></i><span>Password</span></a></li>
                  <li><form action="{{route('logout')}}" id="logoutfrm" method="post">@csrf<i data-feather="log-in"> </i><span onclick="logout()">Log Out</span></form></li>
                </ul>
              </li>
            </ul>
          </div>
        <script class="result-template" type="text/x-handlebars-template">
            ...
            <div class="ProfileCard-realName">{{Auth::user()->f_name}}</div>
            </div>
            </div>
          </script>
