...
class BusinessController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
          ...
          $this->validate($request,[
            ...
            'recent_campaigns'=>['required'],
            'industry_name'=>['required'],
            'detail_of_buisness'=>['required'],
        ]);
           ...
           try{
            ...
            $user->update();
             $b_detial=Business_detail::findOrFail(Auth::user()->businessdetail->id);
                $b_detial->website_link=$request->website_link;
                $b_detial->buisness_name=$request->buisness_name;
                $b_detial->nature_of_buisness=$request->nature_of_buisness;  
                $b_detial->recent_campaigns=$request->recent_campaigns;
                $b_detial->industry_name=$request->industry_name;
                $b_detial->detail_of_buisness=$request->detail_of_buisness;  
                $b_detial->update(); 
